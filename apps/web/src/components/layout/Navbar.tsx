              ...
              <div className="relative">
                <svg className="h-9 w-9 transition-transform duration-300 group-hover:scale-110" viewBox="0 0 48 48">
                  <defs>
                    ...
                    <linearGradient id="navHandle" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" stop-color="#3f3f46"/>
                      <stop offset="100%" stop-color="#27272a"/>
                    </linearGradient>
                  </defs>
                  <path d="M24 3L27 33H21L24 3Z" fill="url(#navBlade)"/>
                  <path d="M24 6L24.5 28" stroke="#a1a1aa" stroke-width="1" stroke-linecap="round"/>
                  <rect x="10" y="33" width="28" height="5" rx="1.5" fill="url(#navGuard)"/>
                  ...
                  <rect x="21" y="38" width="6" height="6" rx="1" fill="url(#navHandle)"/>
                  <ellipse cx="24" cy="45" rx="4" ry="2.5" fill="url(#navGuard)"/>
                </svg>
