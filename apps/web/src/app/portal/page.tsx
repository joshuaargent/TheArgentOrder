...
export default function PortalPage() {
  ...
  return (
    <main className="min-h-screen mesh-gradient flex items-center justify-center relative p-4">
      {/* Ambient Background */}
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-card p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:scale-[1.02] active:scale-[0.98]"
          >
