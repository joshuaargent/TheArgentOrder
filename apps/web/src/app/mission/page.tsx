          ...
          <div className="flex items-center gap-3">
            <svg className="h-6 w-6" viewBox="0 0 48 48">
              <defs>
                ...
                <linearGradient id="missHandle" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stop-color="#52525b"/>
                  <stop offset="100%" stop-color="#27272a"/>
                </linearGradient>
              </defs>
              <path d="M24 2L28 36H20L24 2Z" fill="url(#missBlade)"/>
              <path d="M24 5L24.5 30" stroke="#71717a" stroke-width="1" stroke-linecap="round" stroke-opacity="0.6"/>
              <rect x="8" y="36" width="32" height="5" rx="1" fill="url(#missGuard)"/>
              <rect x="8" y="36" width="32" height="1.5" rx="0.5" fill="#f5f5f5" fill-opacity="0.5"/>
              <rect x="20" y="41" width="8" height="5" rx="1" fill="url(#missHandle)"/>
              <ellipse cx="24" cy="47" rx="5" ry="2" fill="url(#missGuard)"/>
            </svg>
