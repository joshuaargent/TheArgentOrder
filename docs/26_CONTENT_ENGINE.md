...
Content is not the mission.

Content is the acquisition mechanism.
...
Content exists to move men into the ecosystem.

---

# Core Principle

Never create content for views.

Create content for transformation.
...
Every piece of content follows:
...
Direct Discord links are forbidden.
...
A man without direction suffers
...
# Discord Content Injection

Every major content piece enters Discord.
...
* Rage farm
* Use clickbait that breaks trust
* Humiliate struggling men
* Create outrage for engagement
...
Content is successful when it produces changed men.
